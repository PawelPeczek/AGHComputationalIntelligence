...
from framework.problems.singleobjective.schafferF6 import SchafferF6
    ...
    for _ in range(number_of_tries):
        clonal_selections = [
            ...
            ClonalSelection(
                ...
                clone_rate=20,
                mutation=PolynomialMutation(probability=1 / (problem.number_of_variables * 5), distribution_index=20),
                termination_criterion=StoppingByEvaluations(max_evaluations=max_evaluations)
            ),
            ClonalSelection(
                problem=problem,
